...
class stellarIntentHandler(stellarBaseHandler):
    def __init__(self, client: OpenAI, model_name: str, config: stellarIntentConfig):
        """
        ...
        Args:
            ...
            config (stellarIntentConfig): The configuration for stellar-Intent.
        """
    ...
    async def chat_completion(self, req: ChatMessage) -> ChatCompletionResponse:
        ...
        """
        logger.info("[stellar-Intent] - ChatCompletion")
...
class stellarFunctionHandler(stellarBaseHandler):
    def __init__(
        self,
        client: OpenAI,
        model_name: str,
        config: stellarFunctionConfig,
    ):
        """
        ...
        Args:
            client (OpenAI): An OpenAI client instance.
            model_name (str): Name of the model to use.
            config (stellarFunctionConfig): The configuration for stellar-Function
        """
    ...
    async def chat_completion(self, req: ChatMessage) -> ChatCompletionResponse:
        ...
        Note:
            Currently only support vllm inference
        """
        logger.info("[stellar-Function] - ChatCompletion")
        ...
        if len(extracted["result"]) and extracted["status"]:
            ...
            if verified["status"]:
                ...
                # raise ValueError(
                #     f"[stellar-Function]: Invalid tool call - {verified['message']}"
                # )
        else:
