...
**Prompt guard** is a security and validation feature offered in stellar to protect agents, by filtering and analyzing prompts before they reach your application logic.
...
- **Prompt Sanitization via stellar-Guard**
...
.. Note::
    Today, stellar offers support for jailbreak via stellar-Guard. We will be adding support for additional guards in Q1, 2025 (including response guardrails)

What Is stellar-Guard
~~~~~~~~~~~~~~~~~~
`stellar-Guard <https://huggingface.co/collections/stellarlaboratory/stellar-guard-6702bdc08b889e4bce8f446d>`_ is a robust classifier model specifically trained on a diverse corpus of prompt attacks.
It excels at detecting explicitly malicious prompts, providing an essential layer of security for LLM applications.

By embedding stellar-Guard within the stellar stellar itecture, we empower developers to build robust, LLM-powered applications while prioritizing security and safety. With stellar-Guard, you can navigate the complexities of prompt management with confidence, knowing you have a reliable defense against malicious input.


Example Configuration
~~~~~~~~~~~~~~~~~~~~~
Here is an example of using stellar-Guard in stellar:

.. literalinclude:: includes/stellar_config.yaml
    :language: yaml
    :linenos:
    :lines: 22-26
    :caption: stellar-Guard Example Configuration

How stellar-Guard Works
----------------------

#. **Pre-Processing Stage**

    As a request or prompt is received, stellar Guard first performs validation. If any violations are detected, the input is flagged, and a tailored error message may be returned.
...
Benefits of Using stellar Guard
------------------------------
